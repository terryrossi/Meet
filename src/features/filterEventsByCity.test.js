...
defineFeature(feature, (test) => {
	test('when user hasn’t searched for a city, show upcoming events from all cities.', ({
		...
		// Unit test: I.2.c.iv: updates list of suggestions correctly when user types in city textbox
		test('User should see a list of suggestions when they search for a city.', ({
			...
			then(
				...
				() => {
					...
					// Expecting 2 suggestions in return. ("Berlin, Germany" and "See all cities").
	...
	test('User can select a city from the suggested list.', ({ given, and, when, then }) => {
		...
		// Unit Test: I.3.c.i: renders the suggestion text in the textbox upon clicking on the suggestion
